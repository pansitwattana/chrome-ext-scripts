// https://shopee.co.th/product/40886114/4102215836?utm_source=an_15361000000&utm_medium=affiliates&utm_campaign=-&utm_content=midmonthnintendoswitchteaser----&af_siteid=an_15361000000&pid=affiliates&af_click_lookback=7d&af_viewthrough_lookback=1d&is_retargeting=true&af_reengagement_window=7d&af_sub_siteid=midmonthnintendoswitchteaser----&c=-&fbclid=IwAR38sy7kMyJz57JkSBIIK7qtOug2aeRwicyvBAf29sdvsN4331-OlFFN3mk
...
async function main() {
  ...
  function checkForJS_Finish() {
    if (document.getElementsByClassName('product-variation').length > 0) {
      clearInterval(jsInitChecktimer);
      runSelectItem(modelText);
    }
  }
}
...
async function runSelectItem(modelText) {
  // -------------------------------------------//
  console.log('STEP 2: Select the mathing model (Optional')
